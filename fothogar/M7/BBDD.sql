DROP DATABASE IF EXISTS Fothogar;
CREATE DATABASE Fothogar;
USE Fothogar;
...
CREATE TABLE casas (
  ...
  inmueble ENUM('casa', 'local') NOT NULL,
...
CREATE TABLE imagen (
  ...
  idCasa INT NOT NULL,
  foto VARCHAR(255),
  FOREIGN KEY (idCasa) REFERENCES casas(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO districtes (id, slug, nom) VALUES
...
ALTER TABLE districtes ADD PRIMARY KEY (id);

ALTER TABLE districtes MODIFY id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;

INSERT INTO barris (id, id_districte, slug, nom) VALUES
...
ALTER TABLE barris ADD PRIMARY KEY (id);
ALTER TABLE barris MODIFY id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
COMMIT;